...
<script language="Javascript">	
	$(document).ready( function(){
		submitScreenForm('searchIndexView','indexViewResultTable');
	});
</script>
											...
											<div class="contenttable">
												<div style=" padding: 0px; left: -2px; top: 1px; width:99.6%;" class="popform">
													<div style="cursor: move; white-space: nowrap;" class="hdr" onmousedown="on_div_drag_start(event,this);">
														...
														<em class="med">Search View:</em>
													</div>
													<div id="pop_form_body">
														<div id="advancedAnalysisSearchFormTable">
															<s:form action="searchIndexView.do" method="post">												
																<table class="formTable" summary="" datatable="0">																	
																	<tbody>	
																		<tr class="row" id="AppApplicationInstallPortletname_row">
																			<td><label class="fieldLabel">Look for :</label></td>
																			<td class="inputField">
																				<div>
																					<s:textfield name="freeTextSearchInput" id="indexViewDataDate" cssClass="textinputVeryLong"/>
																				</div>
																				Use "$nse_code" to search all scrips most similar to nse_code (For other free text use space separated words. e.g: Polymer Insulators will search as (Polymer & Insulators) )
																			</td>
																			...
																			<td>
																				<button type="button" onclick="this.form.pageNumber.value=1;submitScreenForm('searchIndexView','indexViewResultTable')" name="Back" class="formButton">
																					Search
																				</button>
																			</td>																		
																		</tr>																																																					
