								...
								<div class="spui-titlebar">
									<div class="float-container">										
										...
										<div class="spui-titlebar-button-panel">
											<a href="javascript:void()" onclick="javascript:toggleDiv('dashboardSearchFormTable')">
												...
												<div id="AppDeploymentsControlPortlet" class="spui-window  ">
													<div class="spui-window-content">
														<div class="contenttable">
															<div id="dashboardSearchFormTable">
																<JqGridTable:addTable tableIdentifier="DashboardPage_ScripTable" formRequired="true"/>
															</div>
														</div>
													</div>
												</div>
