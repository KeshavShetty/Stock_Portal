								...
								<div class="c2">
									...
									<div class="spui-window-content">
										<ul>
											...
											<li onmouseover="this.className='quicklinksrowover';" onmouseout="this.className='quicklinksrowout';">
												<a href="<%=request.getContextPath()%>/optionsummary.html?indexName=NIFTY&forDate=<%=(new SimpleDateFormat("dd/MM/yyyy")).format(new Date())%>&nooftopois=10&filterOptionWorth=true&greekname=iv" target="_blank">NIFTY 50 Live Option Summary</a>
											</li>
											<li onmouseover="this.className='quicklinksrowover';" onmouseout="this.className='quicklinksrowout';">
											...
											<li onmouseover="this.className='quicklinksrowover';" onmouseout="this.className='quicklinksrowout';">
												<a href="<%=request.getContextPath()%>/optionsDrawdownChart.html?fromDate=01/09/2025&toDate=<%=(new SimpleDateFormat("dd/MM/yyyy")).format(new Date())%>&dte=0&strategyIds=9033,9896" target="_blank">[Drawdown Chart DTE0]</a>&nbsp;
												<a href="<%=request.getContextPath()%>/optionsDrawdownChart.html?fromDate=01/09/2025&toDate=<%=(new SimpleDateFormat("dd/MM/yyyy")).format(new Date())%>&dte=0,1,4,5&strategyIds=9886,9880,9892,23" target="_blank">[All DTE]</a>&nbsp;
											</li>
											<li onmouseover="this.className='quicklinksrowover';" onmouseout="this.className='quicklinksrowout';">
