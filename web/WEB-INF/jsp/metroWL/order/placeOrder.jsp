									...
									<div id="AppApplicationInstallPortlet" class="spui-window  ">
										<div class="spui-window-content">
											...
											<div class="contenttable">		
												<s:form action="placeOrder.do" method="post">
													<table class="formTable" summary="" datatable="0">														
														<tbody>
															<tr class="row">
																<td colspan="2" style="text-align: center;">
																	<label>Place ICICI Order for</label><STRONG><s:property value="selectedScrip.name" />(ICICI:<s:property value="selectedScrip.iciciCode" />)</STRONG>
																</td>
															</tr>
															<tr class="row">
																...
																<td class="inputField">
																	<div>
																		<s:select cssClass="textinput" headerKey="" headerValue="Select one" name="transactionType" id="transactionType" list="#{'Buy':'Buy', 'Sell':'Sell'}" />
																	</div>
																</td>
															</tr>
															<tr class="row">
															...
															<tr class="row">
																...
																<td class="inputField">
																	<div>
																		<s:select cssClass="textinput" headerKey="" headerValue="Select one" name="orderType" id="orderType" list="#{'Market':'Market', 'Limit':'Limit'}" />
																	</div>
																</td>
															</tr>
															<tr class="row">
													...
													<div class="lowerButtonBar">
														<div class="buttonBar">
															&nbsp;
															<button type="button" id="submitLoginButton" name="submitLoginButton" class="formButton" onclick="javascript:submitFloatingForm('placeOrder');">
																	Place
															</button>  
															&nbsp;&nbsp;
