...
/**
 *  @web.servlet name="OISpikeChartQuoteServlet"
 *      description="Stock data"
 * 
 *  @web.servlet-mapping url-pattern="/chart/OISpikeChartQuote"
 * 
 * @author kshe
 *
 */

public class OISpikeChartQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String csvFilename = dataManager.getOISpikeData(indexName, forDate, nooftopois, filterOptionWorth);	   // getIndividualOptionOIData
