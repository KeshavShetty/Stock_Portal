...
/**
 *  @web.servlet name="Option1MGreeksMovementChartQuoteServlet" 
 *      description="Stock data"
 * 
 *  @web.servlet-mapping url-pattern="/chart/Option1MGreeksMovementChartQuote"
 * 
 * @author kshe
 *
 */

public class Option1MGreeksMovementChartQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String optionnames = request.getParameter("optionnames");
	        
	        String csvFilename = dataManager.getOption1MGreeksMovements(forDate, optionnames);	   // getIndividualOptionOIData
