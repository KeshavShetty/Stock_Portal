...
public class OptionVegaValueAnalysisChartQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String csvFilename = dataManager.getOptionVegaValueAnalysis(indexname, forDate, noOfTopOis);	   // getIndividualOptionOIData
