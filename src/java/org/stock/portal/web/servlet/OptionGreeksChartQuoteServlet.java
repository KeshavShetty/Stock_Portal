...
/**
 *  @web.servlet name="OptionGreeksChartQuoteServlet"
 *      description="Stock data"
 * 
 *  @web.servlet-mapping url-pattern="/chart/OptionGreeksChartQuote"
 * 
 * @author kshe
 *
 */

public class OptionGreeksChartQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String csvFilename = dataManager.getOptionGreeksData(optionName, forDate);	   // getIndividualOptionOIData
