...
/**
 *  @web.servlet name="OptionSpikesChartQuoteServlet"
 *      description="Stock data"
 * 
 *  @web.servlet-mapping url-pattern="/chart/OptionSpikesChartQuote"
 * 
 * @author kshe
 *
 */

public class OptionSpikesChartQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String csvFilename = dataManager.getOptionSpikeData(indexName, forDate);	   // getIndividualOptionOIData
