...
/**
 *  @web.servlet name="OptionMaxOIWorthReversionChartQuoteServlet"
 *      description="Stock data"
 * 
 *  @web.servlet-mapping url-pattern="/chart/OptionMaxOIWorthReversionChartQuote"
 * 
 * @author kshe
 *
 */

public class OptionMaxOIWorthReversionChartQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String csvFilename = dataManager.getOptionMaxOIWorthReversionData(indexName, forDate);	   // getIndividualOptionOIData
