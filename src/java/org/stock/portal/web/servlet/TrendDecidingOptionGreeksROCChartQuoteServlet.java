...
/**
 *  @web.servlet name="TrendDecidingOptionGreeksROCChartQuoteServlet" 
 *      description="Stock data"
 * 
 *  @web.servlet-mapping url-pattern="/chart/TrendDecidingOptionGreeksROCChartQuote"
 * 
 * @author kshe
 *
 */

public class TrendDecidingOptionGreeksROCChartQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String csvFilename = dataManager.getTrendDecidingOptionGreeksROC(indexName, forDate, nooftopois, method);
