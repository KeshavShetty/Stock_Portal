...
public class OptionATMMovementAnalysisChartQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String csvFilename = dataManager.getOptionATMMovmentAnalysis(indexname, forDate);	
