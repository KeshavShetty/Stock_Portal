...
/**
 *  @web.servlet name="OptionOIQuoteServlet"
 *      description="Stock data"
 * 
 *  @web.servlet-mapping url-pattern="/chart/OptionOpenInterestChange"
 * 
 * @author kshe
 *
 */

public class OptionOIQuoteServlet extends HttpServlet
{	
