...
/**
 *  @web.servlet name="Option1MPremiumDecayChartQuoteServlet" 
 *      description="Stock data"
 * 
 *  @web.servlet-mapping url-pattern="/chart/Option1MPremiumDecayChartQuote"
 * 
 * @author kshe
 *
 */

public class Option1MPremiumDecayChartQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String csvFilename = dataManager.getOption1MPremiumDecay(forDate, optionnames);	   // getIndividualOptionOIData
