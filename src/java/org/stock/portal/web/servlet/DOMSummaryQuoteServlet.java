...
/**
 *  @web.servlet name="DomSummaryQuoteServlet" 
 *      description="Stock data"
 * 
 *  @web.servlet-mapping url-pattern="/chart/DomSummaryQuoteQuote"
 * 
 * @author kshe
 *
 */

public class DOMSummaryQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String scripName = request.getParameter("scripName");
	        
	        String csvFilename = dataManager.getDOMSummary(forDate, scripName);	   // getIndividualOptionOIData
