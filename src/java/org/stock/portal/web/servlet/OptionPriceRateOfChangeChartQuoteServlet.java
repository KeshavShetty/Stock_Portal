...
/**
 *  @web.servlet name="OptionPriceRateOfChangeChartQuoteServlet" 
 *      description="Stock data"
 * 
 *  @web.servlet-mapping url-pattern="/chart/OptionPriceRateOfChangeChartQuote"
 * 
 * @author kshe
 *
 */

public class OptionPriceRateOfChangeChartQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String csvFilename = dataManager.getOptionPriceRateOfChange(indexName, forDate, basedelta);	   // getIndividualOptionOIData
