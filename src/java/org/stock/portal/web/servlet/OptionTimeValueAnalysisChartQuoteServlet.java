...
/**
 *  @web.servlet name="OptionTimeValueAnalysisChartQuoteServlet" 
 *      description="Stock data"
 * 
 *  @web.servlet-mapping url-pattern="/chart/OptionTimeValueAnalysisChartQuote"
 * 
 * @author kshe
 *
 */

public class OptionTimeValueAnalysisChartQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String csvFilename = dataManager.getOptionTimeValueAnalysis(indexname, forDate);	   // getIndividualOptionOIData
