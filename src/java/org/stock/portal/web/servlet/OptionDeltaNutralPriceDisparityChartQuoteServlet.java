...
/**
 *  @web.servlet name="OptionDeltaNutralPriceDisparityChartQuoteServlet"
 *      description="Stock data"
 * 
 *  @web.servlet-mapping url-pattern="/chart/OptionDeltaNutralPriceDisparityChartQuote"
 * 
 * @author kshe
 *
 */

public class OptionDeltaNutralPriceDisparityChartQuoteServlet extends HttpServlet
{	
		...
		throws ServletException,IOException
	{
		try
		{
	        ...
	        String csvFilename = dataManager.getOptionDeltaNeutralPriceDisparity(indexName, forDate);	   // getIndividualOptionOIData
