package org.stock.portal.web.struts2.convention;
...
import org.stock.portal.web.util.finder.ClassFinder;
 ...
 * </p>
 */
public class SPPackagedBasedActionConfigBuilder implements ActionConfigBuilder{
	private static final Logger LOG = LoggerFactory.getLogger(SPPackagedBasedActionConfigBuilder.class);
	 ...
	 */
	@Inject
	public SPPackagedBasedActionConfigBuilder(Configuration configuration, Container container, ObjectFactory objectFactory,
	...
	@Inject(value = "struts.convention.earPackage", required = false)
	public void setEarPackage(String earPackage) {
		this.earPackage = earPackage;
	}	
	...
	protected Set<Class<?>> findActions() {
		...
		try {
			if (actionPackages != null || (packageLocators != null && !disablePackageLocatorsScanning)) {
				ClassFinder finder = new ClassFinder(getClassLoaderInterface(), buildUrlSet().getUrls(), true, this.fileProtocols, this.earPackage);
